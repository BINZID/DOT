...
public class Occurrence {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, title, type, eventdate, location, country, province, city, county, locality, lng, lat, sourcesId, taxonId, status, inputer, inputtime, synchstatus, synchdate);
    }
}
