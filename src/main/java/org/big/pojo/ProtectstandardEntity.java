 ...
 */
@Entity
@Table(name = "protectstandard", schema = "dot", catalog = "")
public class ProtectstandardEntity {
    private String id;
    ...
    public boolean equals(Object o) {
        ...
        ProtectstandardEntity that = (ProtectstandardEntity) o;
