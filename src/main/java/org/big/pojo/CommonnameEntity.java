 ...
 */
@Entity
@Table(name = "commonname", schema = "dot", catalog = "")
public class CommonnameEntity {
    private String id;
    ...
    public boolean equals(Object o) {
        ...
        CommonnameEntity that = (CommonnameEntity) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, commonname, pinyin, language, sourcesId, specialistId, taxonId, remark, dbaseId, status, inputer, inputtime, synchdate);
    }
}
