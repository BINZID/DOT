...
public interface ProtectstandardRepository extends BaseRepository<Protectstandard, String> {
    ...
    /**
	 * <b>根据保护标准、标准版本确定保护级别</b>
	 * <p><根据保护标准、标准版本确定保护级别/p>
	 * @param standardName
	 * @param version
	 * @return
	 */
	Protectstandard findOneByStandardnameAndVersion(String standardName, String version);
	/**
	 * <b>根据标准名称、标准版本、保护级别查找对应保护标准</b>
	 * <p> 根据标准名称、标准版本、保护级别查找对应保护标准</p>
	 * @param standardName
	 * @param version
	 * @param protlevel
	 * @return
	 */
	Protectstandard findOneByStandardnameAndVersionAndProtlevel(String standardName, String version, String protlevel);
