...
public interface TraitontologyRepository extends BaseRepository<Traitontology, Integer> {
	...
	/**
     *<b>根据Cnterm或Enterm查找一个Traitontology实体的ID</b>
     *<p> 根据Cnterm或Enterm查找一个Traitontology实体的ID</p>
     * @author BINZI
     * @param cnterm 
     * @return 
     */
	@Query(value = "Select to.id From Traitontology to Where to.cnterm = ?1 or to.enterm = ?1")
	String findOneByCntermOrEnterm(String cnterm);
