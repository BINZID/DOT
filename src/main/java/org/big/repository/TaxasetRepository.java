...
public interface TaxasetRepository extends BaseRepository<Taxaset, String> {
     ...
     * @return
     */
    @Query(value = "select count(t) from Taxaset t where t.tsname = ?1 and t.dataset.id = ?2")
	long countTaxasetsByTsname(String tsname, String datasetId);
}
