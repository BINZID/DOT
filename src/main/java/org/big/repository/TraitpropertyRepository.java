...
public interface TraitpropertyRepository extends BaseRepository<Traitproperty, Integer> {
	...
	/**
     *<b>根据Traitproperty名称查找一个Traitproperty实体的Id</b>
     *<p> 根据Traitproperty名称查找一个Traitproperty实体的Id</p>
     * @author BINZI
     * @param name 实体的id
     * @return 
     */
	@Query(value = "Select tp.id From Traitproperty tp Where tp.cnterm = ?1 or tp.enterm = ?1")
	String findOneByCntermOrEnterm(String name);
