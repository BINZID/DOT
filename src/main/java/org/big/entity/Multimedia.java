...
public class Multimedia implements Serializable {
	...
	public Multimedia(String mediatype, String context, String title, String oldPath, String sourcesid, String expert,
			String rightsholder, String copyright, String lisenceid, String path, String createtime, String creator,
			String publisher, String contributor, String country, String province, String city, String county,
			String locality, Double lng, Double lat, String refjson, License license, Taxon taxon) throws ParseException {
		super();
