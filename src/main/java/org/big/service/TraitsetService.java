...
public interface TraitsetService {
	...
	/**
	 *<b>为上传的Traitset选则或新建一个术语集</b>
	 *<p> 为上传的Traitset选则或新建一个术语集</p>
	 * @author BINZI
	 * @param request 页面请求
	 * @return com.alibaba.fastjson.JSON
	 */
	JSON selectForUpload(HttpServletRequest request);
	/**
     *<b>根据Id查找一个实体</b>
     *<p> 根据Id查找一个实体</p>
     * @author BINZI
     ...
     * @return 
     */
	JSON saveOne(@Valid Traitset thisTraitset);
	/**
     *<b>根据Id删除一个实体</b>
     *<p> 根据Id删除一个实体</p>
     * @author BINZI
     ...
     * @return 
     */
	Boolean countTraitsetsByName(HttpServletRequest request);
