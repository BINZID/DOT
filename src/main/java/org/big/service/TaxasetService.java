...
public interface TaxasetService {
     ...
     *<p> 当前Dataset下的Taxaset的select检索列表(含新建)</p>
     * @author BINZI
     * @param request 页面请求
     * @return com.alibaba.fastjson.JSON
     */
	 ...
	 * @return
	 */
	JSON findTaxasetListByDatasetId(String dsid, HttpServletRequest request);

	/**
     *<b>根据taname统计Taxaset实体个数</b>
     *<p> 根据tsname统计Taxaset实体个数</p>
     * @author BINZI
     * @param request 页面请求
     * @return 
     */
	Boolean countTaxasetsByTsname(HttpServletRequest request);
