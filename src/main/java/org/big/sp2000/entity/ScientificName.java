...
public class ScientificName implements Serializable {
	...
	public String toString() {
		return "ScientificName [nameCode=" + nameCode + ", acceptedNameCode=" + acceptedNameCode + ", author=" + author
				+ ", author2=" + author2 + ", canonicalName=" + canonicalName + ", comment=" + comment + ", comments="
				+ comments + ", databaseId=" + databaseId + ", familyCode=" + familyCode + ", familyId=" + familyId
				+ ", genus=" + genus + ", genusC=" + genusC + ", genusCPy=" + genusCPy + ", genuswithsubgenus="
				+ genuswithsubgenus + ", infraspecies=" + infraspecies + ", infraspeciesC=" + infraspeciesC
				+ ", infraspeciesCPy=" + infraspeciesCPy + ", infraspeciesCPy2=" + infraspeciesCPy2
				+ ", infraspeciesC2=" + infraspeciesC2 + ", infraspeciesMarker=" + infraspeciesMarker
				+ ", infraspeciesMarker2=" + infraspeciesMarker2 + ", infraspecies2=" + infraspecies2
				+ ", isAcceptedName=" + isAcceptedName + ", scrutinyDate=" + scrutinyDate + ", sp2000StatusId="
				+ sp2000StatusId + ", specialistCode=" + specialistCode + ", specialistId=" + specialistId
				+ ", species=" + species + ", speciesC=" + speciesC + ", speciesCPy=" + speciesCPy + ", webSite="
				+ webSite + "]";
	}
